        ...
        <Animated.View style={[authStyles.content, { opacity: fadeAnim }]}>
          ...
          {signInError && (
            ...
            >
              ...
              />
              <Text
                style={[authStyles.bannerText, { color: theme.colors.danger }]}
              >
                {signInError}
              </Text>
            </View>
          ...
          >
            ...
            >
              ...
              >
                <Text style={[authStyles.primaryButtonText, { color: "#fff" }]}>
            ...
            <View style={authStyles.divider}>
              ...
              />
              <Text
                style={[authStyles.dividerText, { color: theme.colors.muted }]}
              >
                OR
              </Text>
              <View
